  ...
  return (
    <div className="py-20" id="services">
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="grid grid-cols-1 gap-5 pt-10 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 lg:px-4">
          {sections.map((section, index) => (
            <CardContainer key={index} className="max-w-xs">
              <CardBody className="hover:borderColor relative rounded-lg bg-zinc-200 p-6 shadow-lg">
                ...
                <CardItem translateZ="60">
                  <p className="mb-7 mt-10 text-gray-600">
                    {section.description}
                  </p>
                </CardItem>
              </CardBody>
