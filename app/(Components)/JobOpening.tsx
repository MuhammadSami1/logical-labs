...
const JobOpening = () => {
  return (
    <div className="mx-auto mt-7 grid max-w-7xl grid-cols-1 px-2 text-white md:grid-cols-2 md:px-0">
      <div className="flex flex-col justify-end">
        <div className="flex justify-center gap-3 pt-7 text-5xl md:justify-normal">
          JOB
      ...
      <div className="w-full md:ml-60 md:max-w-sm">
        <div className="rounded-md bg-[#38A3A5] px-10 py-7">
          <div className="flex justify-center pb-5 text-2xl font-normal tracking-wider md:justify-normal md:pb-10">
            CREATE <span className="font-thin">ACCOUNT</span>
          </div>
          <div className="flex flex-col gap-y-5 text-[12px]">
